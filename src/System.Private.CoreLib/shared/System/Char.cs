...
namespace System
{
    ...
    public readonly struct Char : IComparable, IComparable<char>, IEquatable<char>, IConvertible
    {
        ...
        // Contains information about the Latin-1 character range [ U+0000..U+00FF ], with:
        ...
        private static ReadOnlySpan<byte> Latin1CharInfo => new byte[256]
        {
            ...
            0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E,
            0x8B, 0x18, 0x1A, 0x1A, 0x1A, 0x1A, 0x1C, 0x1C, 0x1B, 0x1C, 0x41, 0x16, 0x19, 0x13, 0x1C, 0x1B,
            0x1C, 0x19, 0x0A, 0x0A, 0x1B, 0x41, 0x1C, 0x18, 0x1B, 0x0A, 0x41, 0x17, 0x0A, 0x0A, 0x0A, 0x18,
            0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40,
            0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x19, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x41,
            0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
            0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x19, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41
        };
        ...
        private static UnicodeCategory GetLatin1UnicodeCategory(char ch)
        {
            ...
            return (UnicodeCategory)(Latin1CharInfo[(int)ch] & 0x1f); // category is bottom 5 bits
        }
        ...
        **character c is considered to be a whitespace character.                     **
        ...
        public static bool IsWhiteSpace(char c)
        {
            ...
            if ((uint)index < (uint)Latin1CharInfo.Length)
            {
                return (Latin1CharInfo[index] & IsWhiteSpaceFlag) != 0;
            }
        ...
        ** Check if the specified UnicodeCategory belongs to the letter or digit categories.
        ...
        public static bool IsLetterOrDigit(char c)
        {
            ...
            if ((uint)index < (uint)Latin1CharInfo.Length)
            {
                return (Latin1CharInfo[index] & IsLetterOrDigitFlag) != 0;
            }
        ...
        ** Check if the specified UnicodeCategory belongs to the seprator categories.
        ...
        public static bool IsWhiteSpace(string s, int index)
        {
            ...
            // There are no whitespace values in any Unicode supplementary plane,
            // so there's no point checking for surrogate pair values.
