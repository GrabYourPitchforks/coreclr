...
namespace GenUnicodeProp
{
    internal static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            categoryCasingTable.GenerateTable("CategoryCasingTable", 5, 4);
            ...
            numericGraphemeTable.GenerateTable("NumericGraphemeTable", 5, 4);
            ...
            using (StreamWriter file = File.CreateText(SOURCE_NAME))
            {
                ...
                file.Write("        // 11:5:4 index table of the Unicode category & casing data.");
