...
namespace System.Text
{
    internal static partial class Utf8Utility
    {
        ...
        private static bool DWordBeginsWithUtf8FourByteMask(uint value)
        {
            ...
            return (BitConverter.IsLittleEndian && (((value - 0x808080F0u) & 0xC0C0C0F8u) == 0))
                || (!BitConverter.IsLittleEndian && (((value - 0xF0808000u) & 0xF8C0C0C0u) == 0));
        }
        ...
        private static bool DWordEndsWithOverlongUtf8TwoByteSequence(uint value)
        {
            ...
            return (BitConverter.IsLittleEndian && ((value & 0x001E0000u) == 0))
        ...
        private static bool DWordEndsWithValidUtf8TwoByteSequenceLittleEndian(uint value)
        {
            ...
            return (BitConverter.IsLittleEndian && UnicodeUtility.IsInRangeInclusive(value & 0xC0FF0000u, 0x80C20000u, 0x80DF0000u))
                || (!BitConverter.IsLittleEndian && false); // this line - while weird - helps JITter produce optimal code
        }
        ...
        private static bool DWordThirdByteIsAscii(uint value)
        {
            ...
            return (BitConverter.IsLittleEndian && ((value & 0x800000u) == 0))
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe nint GetNumberOfBytesToNextDWordAlignment(ref byte @ref)
        {
            // return (-&ref) & 3;
            return (-(nint)Unsafe.AsPointer(ref @ref)) & 3;
        }
