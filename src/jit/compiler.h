...
public:
    ...
    GenTree* gtNewIndexRef(var_types typ, GenTree* arrayOp, GenTree* indexOp, bool skipBoundsCheck = false);
...
#if defined(_TARGET_AMD64_) || (defined(_TARGET_X86_) && defined(FEATURE_EH_FUNCLETS))
