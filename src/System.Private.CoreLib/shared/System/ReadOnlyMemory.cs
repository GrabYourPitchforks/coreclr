...
namespace System
{
    ...
    public readonly struct ReadOnlyMemory<T>
    {
        ...
        public ReadOnlyMemory(T[] array, int start, int length)
        {
            ...
            ArgValidationHelper.ValidateStartAndLengthNotOutOfRange(start, length, array.Length);
        ...
        {
            ArgValidationHelper.ValidateStartAndLengthNotOutOfRange(start, length, _length, ExceptionArgument.start);
        ...
        public unsafe ReadOnlySpan<T> Span
        {
            ...
            get
            {
                ...
                if (tmpObject != null)
                {
                    ...
                    ArgValidationHelper.ValidateStartAndLengthNotOutOfRange(desiredStartIndex, desiredLength, lengthOfUnderlyingSpan);
